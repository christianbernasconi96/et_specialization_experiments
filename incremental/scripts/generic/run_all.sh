...
# run with Load
# BOX
bash incremental/scripts/generic/run_all_box.sh -D $DATA -f $FAMILY

### KENN 
# VERTICAL
bash incremental/scripts/generic/run_all_kenn_vertical.sh -D $DATA -f $FAMILY
# HORIZONTAL
bash incremental/scripts/generic/run_all_kenn_horizontal.sh -D $DATA -f $FAMILY
# HORIZONTAL VERTICAL
# bash incremental/scripts/generic/run_all_kenn_horizontal_vertical.sh -D $DATA -f $FAMILY
