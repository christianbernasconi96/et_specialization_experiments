...
# prepare model yaml
MODEL_CONFIG_TEMPLATE='incremental/configs/model/'$DATA'_classifier_bert.yaml'
NEW_MODEL_CONFIG_PATH='incremental/configs/model/generated_config_files/'$DATA'_classifier_bert.yaml'
...
--trainer.callbacks.filename=$INIT_STRING'classifier_adapter_bert_ms' \
...
--logger.name=$INIT_STRING'classifier_adapter_bert_ms'