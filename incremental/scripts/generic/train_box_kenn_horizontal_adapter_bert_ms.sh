...
# prepare model yaml
MODEL_CONFIG_TEMPLATE='incremental/configs/model/'$DATA'_box_kenn_horizontal_Y_bert.yaml'
NEW_MODEL_CONFIG_PATH='incremental/configs/model/generated_config_files/'$DATA'_box_kenn_horizontal_'$FAMILY'_bert.yaml'
...
--trainer.callbacks.filename=$INIT_STRING'box_kenn_horizontal_adapter_bert_ms' \
...
--logger.name=$INIT_STRING'box_kenn_horizontal_adapter_bert_ms'