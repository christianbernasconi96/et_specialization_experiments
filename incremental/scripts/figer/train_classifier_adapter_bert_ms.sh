...
--model incremental/configs/model/figer_classifier_bert.yaml \
--model.checkpoint_to_load=/home/remote_hdd/trained_models/figer/specialization/pretraining/classifier_adapter_bert_ms.ckpt \
