...
--model 'incremental/configs/model/figer_kenn_horizontal_bert.yaml' \
--model.checkpoint_to_load=/home/remote_hdd/trained_models/figer/specialization/pretraining/'kenn_bottom_up_adapter_bert_ms.ckpt' \
