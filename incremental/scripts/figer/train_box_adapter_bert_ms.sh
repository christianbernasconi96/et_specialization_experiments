...
--model incremental/configs/model/figer_box_bert.yaml \
--model.checkpoint_to_load=/home/remote_hdd/trained_models/figer/specialization/pretraining/box_adapter_bert_ms.ckpt \
