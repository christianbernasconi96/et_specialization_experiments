...
# prepare model yaml
MODEL_CONFIG_TEMPLATE='incremental/configs/model/'$DATA'_kenn_X_bert.yaml'
NEW_MODEL_CONFIG_PATH='incremental/configs/model/generated_config_files/'$DATA'_kenn_'$KB_ENCODING'_bert.yaml'
...
--trainer.callbacks.filename=$INIT_STRING'kenn_'$KB_ENCODING'_adapter_bert_ms' \
...
--logger.name=$INIT_STRING'kenn_'$KB_ENCODING'_adapter_bert_ms'
