...
# prepare model yaml
MODEL_CONFIG_TEMPLATE='incremental/configs/model/bbn_kenn_horizontal_X_Y_bert.yaml'
NEW_MODEL_CONFIG_PATH='incremental/configs/model/generated_config_files/bbn_kenn_horizontal_'$KB_ENCODING'_'$FAMILY'_bert.yaml'
...
--model.checkpoint_to_load=/home/remote_hdd/trained_models/bbn/specialization/pretraining/'kenn_'$KB_ENCODING'_adapter_bert_ms.ckpt' \
