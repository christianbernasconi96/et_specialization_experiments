...
--model incremental/configs/model/bbn_classifier_bert.yaml \
--model.checkpoint_to_load=/home/remote_hdd/trained_models/bbn/specialization/pretraining/classifier_adapter_bert_ms.ckpt \
