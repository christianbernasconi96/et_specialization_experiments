...
from entity_typing_framework.main_module.main_module import IncrementalKENNMultilossMainModule
...
cli = MyLightningCLI(IncrementalKENNMultilossMainModule, IncrementalDatasetManagerWithTestLog, save_config_overwrite=True)
# load best model
