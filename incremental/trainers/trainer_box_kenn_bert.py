...
from entity_typing_framework.main_module.main_module import IncrementalBoxKENNMultilossMainModule
...
cli = MyLightningCLI(IncrementalBoxKENNMultilossMainModule, IncrementalDatasetManagerWithTestLog, save_config_overwrite=True)
# load best model
