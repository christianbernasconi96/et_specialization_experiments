from entity_typing_framework.dataset_classes.large_datasets.large_dataset_managers import ELMoDatasetManagerLarge
...
cli = MyLightningCLI(KENNMultilossMainModule, ELMoDatasetManagerLarge, save_config_overwrite=True)
# load best model
